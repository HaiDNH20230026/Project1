...
public class TaskController {
     ...
     */
    @PutMapping("/task/{task-id}/completion")
    public ResponseEntity<Void> toggleTaskCompletion(
        @AuthenticationPrincipal UserDetails userDetails,
        @PathVariable("task-id") Long id,
        @RequestBody java.util.Map<String, Boolean> body) throws Exception {
        ...
        taskService.toggleTaskCompletion(id, userDetails.getUsername(), isCompleted);
