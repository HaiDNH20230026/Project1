        ...
        <div className="month-calendar">
            <div className="month-calendar-header">
                {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day, index) => (
                    <div key={index} className={day === "Sun" ? "day-of-the-week-sunday" : "month-calendar-day-of-the-week"}>
                        {day}
                    </div>
                ))}
            </div>
                                        ...
                                        {dayEvents.length < 3 ? (
                                            <>
                                                {dayEvents.slice(0, 2).map(event => (
                                                    <>
                                                        <div key={event.id} className={`event-item ${event.eventType === 'AI_GENERATED' ? 'ai-generated-event' : ''}`} onClick={(e) => handleEventClick(event, e)} style={{background: getRgbByColorName(event.color, event.eventType)}}>
