      ...
      <div className="day-calendar-content">
        ...
        <div className="day-calendar-schedule">
          {events.map((event, index) => {
            ...
            const isShortEvent = height < 40; // Event less than 1 hour

            console.log(event.color)
            return (
              <div
                key={event.id}
                className={`event-box ${event.eventType === 'AI_GENERATED' ? 'ai-generated-event' : ''}`}
                style={{
                    top: topPosition,
          ...
          {/* {tasks.map((task, index) => {
            ...
            return (
                ...
                style={{
                    top: topPosition,
                    left: "0px", // Position overlapping events to the left
                    height: height,
                    cursor: "pointer",
                    justifyItems:"center",
                    background:"#039BE5"
                ...
                onClick={() => handleTaskClick(task)} // Event on click
                >
